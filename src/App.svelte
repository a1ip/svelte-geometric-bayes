...
<main>
	...
	<div id="bayes-container" bind:clientHeight={parentHeight} bind:clientWidth={parentWidth}>
		<Resizable {...parentDims} bind:width={pH} bind:height={pNotEGivenH} color="teal" resizable="x" handlePos="top: 0%; left: 100%">
			<span style="left: 50%; top: 0; transform: translate(-50%, calc(-100% - 1ex));">
				p(H) = {Math.round(pH)}%
			</span>
		</Resizable>
		<Resizable {...parentDims} bind:width={pH} bind:height={pEGivenH} color="DeepSkyBlue" resizable="y" pos="bottom: 0; left: 0;">
			<span style="left: 0; top: 50%; transform: translate(calc(-100% - 1ex), -50%);">
				p(E|H) = {Math.round(pEGivenH)}%
			</span>
		</Resizable>
		<Resizable {...parentDims} bind:width={pNotH} bind:height={pEGivenNotH} color="SteelBlue" resizable="y" pos="bottom: 0; right: 0;" handlePos="top: 0%; left: 100%">
